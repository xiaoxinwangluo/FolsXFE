 ...
 * @since   1.4
 */
public class XCLinkedHashMap<K,V>
extends XCHashMap<K,V>
implements Map<K,V> {
     ...
     */
    static class LinkedHashMapEntry<K,V> extends XCHashMap.Node<K,V> {
     ...
     */
    public XCLinkedHashMap(int initialCapacity, float loadFactor) {
     ...
     * @throws IllegalArgumentException if the initial capacity is negative
     */
    public XCLinkedHashMap(int initialCapacity) {
     ...
     */
    public XCLinkedHashMap(Map<? extends K, ? extends V> m) {
        super();
        accessOrder = false;
    ...
    final class LinkedKeySet extends AbstractSet<K> {
        ...
        public final void clear()               { XCLinkedHashMap.this.clear(); }
